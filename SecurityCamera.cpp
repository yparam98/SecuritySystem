...
namespace yparam
{
    ...
    void SecurityCamera::run()
    {
        ...
        */
        ...
        // for (int index = 0; index < (this->duration_minutes * 60 * FPS); index++) // minutes x seconds x frames = 1 x 60 x 60 = 3600 frames = 1 minute of video at 60fps
        for (int index = 0; index < (42 * 1 * 6); index++)
        {
